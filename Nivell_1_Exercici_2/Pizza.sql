...
-- -----------------------------------------------------
-- Table `mydb`.`localitys`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`localitys` (
  ...
  CONSTRAINT `fk_locality_province1`
    ...
    REFERENCES `mydb`.`provinces` (`idprovince`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`customers` (
  ...
  CONSTRAINT `fk_customer_locality1`
    ...
    REFERENCES `mydb`.`localitys` (`idlocality`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`orders` (
  ...
  CONSTRAINT `fk_orders_delivery1`
    ...
    REFERENCES `mydb`.`deliverys` (`iddelivery`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`idorders_has_products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`idorders_has_products` (
  `ididorders_has_products` INT NOT NULL AUTO_INCREMENT,
  `products_idproducts` INT NOT NULL,
  `orders_idorders` INT NOT NULL,
  PRIMARY KEY (`ididorders_has_products`),
  INDEX `fk_idorders_has_products_products1_idx` (`products_idproducts` ASC) VISIBLE,
  INDEX `fk_idorders_has_products_orders1_idx` (`orders_idorders` ASC) VISIBLE,
  CONSTRAINT `fk_idorders_has_products_products1`
    FOREIGN KEY (`products_idproducts`)
    REFERENCES `mydb`.`products` (`idproducts`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_idorders_has_products_orders1`
